...
export const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      ...
      "Achieved high test coverage across projects: up to 90% automation test coverage (Katalon) and 65% unit test coverage (Flutter), ensuring long-term stability.",
      "Improved code quality and application reliability, maintaining 85% crash-free rate and 88% SonarQube score.",
      "Refactored key UI components (e.g., Home Page) resulting in up to 45–60% improvement in UX and performance metrics.",
    ...
    achievements: [
      ...
      "Improved UX and performance up to 45–60% through UI refactoring",
      "Integrated e-wallets, transfer, bill payment, purchase and QRIS for seamless transactions",
      "Delivered core banking features across 7+ mobile banking products",
    ],
    skills: [
      "Mobile Banking",
      "Flutter",
